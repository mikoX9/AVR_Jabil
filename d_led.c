...
volatile uint8_t cy1;		//zmienne ulotne, volatile- wylacza optymalizacje dostepu do zmiennych
volatile uint8_t cy2;		//dlatego ze beda wykrzystywane w przerwaniu jak i w programie glownym
...
const uint8_t liczby[11] PROGMEM=                                     //zapisywanie do pamieci FLASH
{
...
{
	LED_DATA_DIR = 0xFF;  //port katodach jako wyjscia
	LED_DATA = 0xFF;      //stan wysoki na katodach, czyli zgaszenie

	ANODY_DIR |= CA1 | CA2 | CA3 | CA4;   //4 piny anod jako wyjscia
	ANODY_PORT |= CA1 | CA2 | CA3 | CA4;	//wygaszenie wszystkich wyswietlaczy
